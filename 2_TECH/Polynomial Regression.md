Polynomial Regression is a form of [[Linear Regression]] in which the relationship between the independent variable $\large x$ and dependent variable $\large y$ is modelled as an nth-degree polynomial.
